...
/// operations related to *NBT Asynchronous Data Transfer* application. It conforms to the
...
class SplashScreenViewModel: ObservableObject {
    ...
    func deactivateAfterDelay() {
        DispatchQueue.main.asyncAfter(deadline: .now() + NBTADTConstants.timeDelay) {
            self.isActive = false
        }
    }
}
